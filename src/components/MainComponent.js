...
class Main extends Component {
    ...
    // Lifecycle method right after react component created and inserted into DOM
    componentDidMount() {
    ...
    render() {
        ...
        const CampsiteWithId = ({match}) => {
            return (
                // Convert match.params.campsiteId to number with +
                <CampsiteInfo 
                    ...
                    <TransitionGroup>
                        <CSSTransition key={this.props.location.key} classNames="page" timeout={300}>
                            <Switch>
                                ...
                                {/* Send on click method with props, need to use anonymous function 
                                    to send props to component we want to route to*/}
